...
**<u>HEROKU:</u>**
/getlog - Log of last 100 lines from Heroku.
/usage - Dyno Usage.
**<u>CONFIG VARS:</u>**
...
!block [ Reply to a User Message] - Blocks the User from Assistant Account.
!unblock [ Reply to a User Message] - Unblocks the User from Assistant Account.
!approve [ Reply to a User Message] - Approves the User for DM.
!disapprove [ Reply to a User Message] - Disapproves the User for DM.
!pfp [ Reply to a Photo] - Changes Assistant account PFP.
!bio [Bio text] - Changes Bio of Assistant Account.
"""
# Add Sudo Users!
...
@app.on_message(filters.command("maintance") & filters.user(SUDOERS))
